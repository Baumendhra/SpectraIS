...
export const Card: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, children, ...props }) => (
  <div
    className={cn(
      "bg-white rounded-lg border border-[#c4a484]/35 shadow-card p-5 text-[#3d2b1f] transition-all",
      className
    )}
    {...props}
  >
...
export const CardDescription: React.FC<React.HTMLAttributes<HTMLParagraphElement>> = ({ className, children, ...props }) => (
  <p className={cn("text-xs text-[#6f4e37]/80 leading-normal", className)} {...props}>
    {children}
  </p>
);
